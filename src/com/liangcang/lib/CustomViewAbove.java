...
import com.liangcang.lib.SlidingMenu.OnClosedListener;
import com.liangcang.lib.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	public int getDestScrollX(int page) {
		...
		case 2:
			...
			return  (int)(mViewBehind.getMenuLeft(mContent, page));
		case 1:
			return  (int) (mContent.getLeft());
		}
		return 0;
	}
	...
	public int getContentLeft() {
		return (int) ((mContent.getLeft() + mContent.getPaddingLeft()));
	}
